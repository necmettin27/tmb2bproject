(function ($) {
    ...
    function initToolbar() {
        ...
        var btnViewSource = $('<button type="button" class="view-source"><i class="fa fa-code"></i> Kodları Gör</button>');
        var btnViewContent = $('<button type="button" class="view-content"><i class="fa fa-file-text-o"></i> Content</button>');
    ...
    function initModalSource() {
        var modal = $(
            ...
            '            <div class="modal-header">' +
            '                <button type="button" class="close" data-dismiss="modal">&times;</button>' +
            '                <h4 class="modal-title">Kaynak</h4>' +
            '            </div>' +
            '            <div class="modal-body">' +
