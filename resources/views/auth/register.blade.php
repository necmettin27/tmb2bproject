<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="productandservices" value="{{ __('register.productandservices') }}" />
                <textarea required class="w-full border rounded-lg text-gray-700 focus:outline-none focus:border-green-500" id="productandservices" name="productandservices"></textarea>
            </div>

            <div class="mt-4">
                <x-jet-label for="companydesciption" value="{{ __('register.companydesciption') }}" />
                <textarea required class="w-full border rounded-lg text-gray-700 focus:outline-none focus:border-green-500" id="companydesciption" name="companydesciption"></textarea>
            </div>
             <div class="mt-4">
