        ...
        <div class="card-body">
            <form action="{{ route('company.update') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-6">
                        <label for="status">@lang('register.randevuonay')</label>
                        <select class="form-control" name="randevuonay" required>
                            <option value=""> {{ __('register.choose') }}</option>
                            <option {{ auth()->user()->randevuonay == "1" ? 'selected':'' }} value="1">@lang('translate.otomatikonaylansin')</option>
                            <option {{ auth()->user()->randevuonay == "2" ? 'selected':'' }} value="2">@lang('translate.onayimasunulsun')</option>
                        </select>
                    </div>
